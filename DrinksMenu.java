...
public class DrinksMenu extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setBackgroundResource(R.drawable.drinkstitle);

        RelativeLayout relativeLayout = (RelativeLayout) findViewById (R.id.meal_menu_fragment);
        relativeLayout.setBackgroundResource(R.drawable.drinkbg);
